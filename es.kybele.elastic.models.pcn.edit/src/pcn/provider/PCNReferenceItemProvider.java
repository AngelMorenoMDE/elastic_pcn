...
public class PCNReferenceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCNProcessStep_action_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCNProcessStep_action_feature", "_UI_PCNProcessStep_type"),
				 PcnPackage.Literals.PCN_PROCESS_STEP__ACTION,
				 true,
				 false,
				 false,
	...
	protected void addPredicatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PCNProcessStep_predicate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PCNProcessStep_predicate_feature", "_UI_PCNProcessStep_type"),
				 PcnPackage.Literals.PCN_PROCESS_STEP__PREDICATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((PCNReference)object).getAction();
