...
public class PCNProcessEntityItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PcnPackage.Literals.PCN_PROCESS_ENTITY__LEFT_DIRECT_INTERACTIONS,
				 PcnFactory.eINSTANCE.createPCNStartProcessStep()));

		newChildDescriptors.add
			(createChildParameter
				(PcnPackage.Literals.PCN_PROCESS_ENTITY__LEFT_DIRECT_INTERACTIONS,
				 PcnFactory.eINSTANCE.createPCNEndProcessStep()));

		newChildDescriptors.add
			(createChildParameter
				(PcnPackage.Literals.PCN_PROCESS_ENTITY__LEFT_DIRECT_INTERACTIONS,
				 PcnFactory.eINSTANCE.createPCNStandardProcessStep()));

		newChildDescriptors.add
			(createChildParameter
				(PcnPackage.Literals.PCN_PROCESS_ENTITY__LEFT_DIRECT_INTERACTIONS,
				 PcnFactory.eINSTANCE.createPCNLongProcessStep()));

		newChildDescriptors.add
			(createChildParameter
				(PcnPackage.Literals.PCN_PROCESS_ENTITY__LEFT_DIRECT_INTERACTIONS,
				 PcnFactory.eINSTANCE.createPCNWaitProcessStep()));

		newChildDescriptors.add
			(createChildParameter
				(PcnPackage.Literals.PCN_PROCESS_ENTITY__LEFT_DIRECT_INTERACTIONS,
				 PcnFactory.eINSTANCE.createPCNDecisionProcessStep()));
